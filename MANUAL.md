# Manual Setup Steps for Minions Prospecting
...
Go to **GitHub → mxn2020/minions-prospecting → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-prospecting` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-prospecting-web`
- **GitHub repo**: `mxn2020/minions-prospecting`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `prospecting.minions.wtf`

### Documentation
- **Netlify site name**: `minions-prospecting-docs`
- **GitHub repo**: `mxn2020/minions-prospecting`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `prospecting.minions.help`

### Blog
- **Netlify site name**: `minions-prospecting-blog`
- **GitHub repo**: `mxn2020/minions-prospecting`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `prospecting.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `prospecting.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `prospecting.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `prospecting.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-prospecting/sdk`](https://www.npmjs.com/package/@minions-prospecting/sdk)
- CLI: [`@minions-prospecting/cli`](https://www.npmjs.com/package/@minions-prospecting/cli)
...
Your package: [`minions-prospecting`](https://pypi.org/project/minions-prospecting/)
...
| Item | Value |
|------|-------|
| Project | `minions-prospecting` |
| SDK (npm) | `@minions-prospecting/sdk` |
| CLI (npm) | `@minions-prospecting/cli` |
| Python (PyPI) | `minions-prospecting` |
| GitHub | `github.com/mxn2020/minions-prospecting` |
| Docs domain | `prospecting.minions.help` |
| Blog domain | `prospecting.minions.blog` |
| App domain | `prospecting.minions.wtf` |
