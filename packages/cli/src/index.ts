...
/**
 * @minions-prospecting/cli — CLI for Minions Prospecting
 *
...
import { customTypes } from '@minions-prospecting/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Prospecting'));
        console.log(chalk.dim('Web search configs, prospect discovery rules, and lead scoring criteria'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-prospecting/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-prospecting/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-prospecting')}`);
